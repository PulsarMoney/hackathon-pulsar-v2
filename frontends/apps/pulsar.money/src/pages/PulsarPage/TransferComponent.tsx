...
import { TokenPresetButton } from "./buttons/Button";
    ...
    <FormProvider {...fields}>
      <div className="w-full max-w-2xl p-6 m-auto mt-20 flex flex-col items-center rounded-lg bg-gradient-to-l from-stone-950 to-neutral-900 gap-8">
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center">
          {userData.tokens
            .sort((token1, token2) => Number(token2.balance) - Number(token1.balance))
            .slice(0, 3)
            .map((token) => {
            return (
              <TokenPresetButton
                ...
                children={
                  <b>
                    ...
                    <div className="flex align-center">
                      ...
                      <img src={getTokenPath(token.identifier)} className="h-5 w-5 my-auto" />
                    </div>
                  </b>
                }
              />
